...
{
    class BossEnemyController : BaseCharecterController
    {
        ...
        protected override void Init()
        {
            ...
            game = FindObjectOfType<BossStage>();
            if (enemy_Ani != null)
                enemy_Ani.Init();
        ...
        public override void ApplyDamage(float damage, bool knockDown)
        {
            ...
            if (_enemyHP == null)
            {
                _enemyHP = UIManager.Instance.Get<BossStageUI>(UIList.BossStageUI).SetBossHPBar(_enemyID);
            }
